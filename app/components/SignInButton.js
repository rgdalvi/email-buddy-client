  ...
  return session ? (
    <>
      <button
        ...
        onClick={() => signOut()}
      >
        <span class="flex flex-row items-center justify-between text-sm font-semi-bold relative z-0 text-black group-hover:text-gray-200 transition ease-in-out duration-500">
